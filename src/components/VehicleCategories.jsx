        ...
        <div className="py-12 bg-[#f5f6fc]">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 px-2 md:px-6">
                {categories.map((item, i) => (
                    <div
                        key={i}
                        className="bg-white rounded-xl p-3 md:p-6 border border-gray-200 shadow-sm hover:shadow-md transition"
                    >
                        {/* Image */}
                        ...
                        {/* Description */}
                        <p className="text-center text-gray-600 text-sm leading-relaxed mb-3 md:mb-6">
                            {item.desc}
                        </p>
