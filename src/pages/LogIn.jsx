...
const LogIn = () => {
    ...
    return (
        <div className="relative inline-block mx-auto">
            ...
            <div className="absolute inset-0 bg-black/60 flex justify-center items-center p-8 rounded-xl">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 w-full max-w-6xl">

                    {/* Left side */}
                    <div className="bg-opacity-50 p-8 rounded h-fit flex-1">
                    ...
                    {/* Right side */}
                    <div className="max-w-sm bg-black/40 backdrop-blur-xl border border-white/30 shadow-2xl rounded-2xl p-8 text-white h-fit flex-1">
